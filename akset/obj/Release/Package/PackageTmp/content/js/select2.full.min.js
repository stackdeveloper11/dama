...
$(function () {
    ...
    $('#get-checked-data1').on('click', function (event) {
        event.preventDefault();
        var checkedItems = {}, counter = 0;
        $("#check-list-box1 li.active").each(function (idx, li) {
            checkedItems[counter] = $(li).text();
            counter++;
        });
        $('#display-json1').html(JSON.stringify(checkedItems, null, '\t'));
    });
    $('#get-checked-data2').on('click', function (event) {
        event.preventDefault();
        var checkedItems = {}, counter = 0;
        ...
        $('#display-json2').html(JSON.stringify(checkedItems, null, '\t'));
    });
    $('#get-checked-data3').on('click', function (event) {
        event.preventDefault();
        var checkedItems = {}, counter = 0;
        $("#check-list-box3 li.active").each(function (idx, li) {
            checkedItems[counter] = $(li).text();
            counter++;
        });
        $('#display-json3').html(JSON.stringify(checkedItems, null, '\t'));
    });
    $('#get-checked-data4').on('click', function (event) {
        event.preventDefault();
        var checkedItems = {}, counter = 0;
        $("#check-list-box4 li.active").each(function (idx, li) {
            checkedItems[counter] = $(li).text();
            counter++;
        });
        $('#display-json4').html(JSON.stringify(checkedItems, null, '\t'));
    });
});